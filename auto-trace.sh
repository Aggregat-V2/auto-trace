...
# aditional space (MB) before reaching minimum space (minfree), at when we begin deleting the oldest .pcap files
schwellwert=1000

# how much .pcap files should be deletet, when reaching "schwellwert"
delpcap=15
