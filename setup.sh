...
sleep 1
wget -O /root/auto-trace/auto-trace.sh https://raw.githubusercontent.com/Aggregat-V2/auto-trace/master/auto-trace.sh && chmod 700 /root/auto-trace/auto-trace.sh > /dev/null 2>&1
killall tcpdump > /dev/null 2>&1
crontab -r > /dev/null 2>&1
cat <(crontab -l) <(echo "SHELL=/bin/bash") |crontab - > /dev/null 2>&1
